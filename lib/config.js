...
exports.init = function () {
  ...
  if (fs.existsSync(config_filename)) {
    ...
    if (json.bluetooth_low_energy) {
      if (json.bluetooth_low_energy.known_devices) {
        Object.keys(json.bluetooth_low_energy.known_devices).forEach(function (k) {
          exports.bluetooth_low_energy.known_devices[k.toString().toLowerCase()] = json.bluetooth_low_energy.known_devices[k];
        });
      }
    }
